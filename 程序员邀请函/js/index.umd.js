(function (global, factory) {
    ...
    class PipCanvas {
        ...
        async init() {
            ...
            document.getElementById("playBtn").addEventListener('touchstart',this.touchHandler.bind(this));//继续
            document.getElementById("playBtn").addEventListener('touchend',this.touchendHandler.bind(this));//停止
			// this.touchHandler(this);
        }
        touchHandler(e) {
            e.stopPropagation();
            e.preventDefault();
