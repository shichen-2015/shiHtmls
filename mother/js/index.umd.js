(function (global, factory) {
    ...
    class PipCanvas {
        ...
        async init() {
            ...
            document.getElementById("playBtn").addEventListener('touchend',this.touchHandler.bind(this));
            document.getElementById("playBtn").addEventListener('touchstart',this.touchendHandler.bind(this));
